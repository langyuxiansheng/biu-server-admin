...
export default {
    ...
    methods: {
        ...
        async init () {
            console.log(this.table.queryData);
            try {
                const { data: { list, total } } = await this.$axios[getSysRolePermissionListToTree.method](getSysRolePermissionListToTree.url, { params: this.table.queryData });
